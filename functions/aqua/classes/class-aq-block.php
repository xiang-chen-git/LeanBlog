...
if(!class_exists('AQ_Block')) {
	class AQ_Block {
	 	...
	 	function block($instance) {
	 		extract($instance);
	 		echo __('function AQ_Block::block should not be accessed directly. Output generated by the ', 'themnific') . strtoupper($id_base). ' Class';
	 	}
	 	...
	 	function form($instance) {
	 		echo '<p class="no-options-block">' . __('There are no options for this block.', 'themnific') . '</p>';
	 		return 'noform';
	 	}
