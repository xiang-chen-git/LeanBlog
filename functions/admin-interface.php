...
if ( ! function_exists( 'themnific_reset_options' ) ) {
	function themnific_reset_options( $options, $page = '' ) {
		...
		if( $page == 'themnificthemes' ) {
			delete_option( 'themnific_options' );
		}
	}
}
...
function themnificthemes_machine($options) {
	...
	foreach ($options as $value) {
		...
		case 'select':
			...
			$output .= '<select class="themnific-input" name="'. esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'">';
		...
		case 'calendar':
			...
			if ( $std != "") { $val = $std; }
			$output .= '<input class="themnific-input-calendar" type="text" name="'.esc_attr( $value['id'] ).'" id="'.esc_attr( $value['id']).'" value="'.esc_attr( $val ).'">';
		...
		case 'time':
			...
			$std = get_option($value['id']);
			if ( $std != "") { $val = $std; }
			$output .= '<input class="themnific-input-time" name="'. esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'" type="text" value="'. esc_attr( $val ) .'" />';
		break;
		case 'textarea':
		...
		case "radio":
			 ...
			 { 
				...
				$output .= '<div class="radio-wrapper"><input class="themnific-input themnific-radio" type="radio" name="'. esc_attr( $value['id'] ) .'" value="'. esc_attr( $key ) .'" '. $checked .' /><label>' . esc_html( $option ) .'</label></div>';
		...
		case "checkbox": 
		   ...
		   $checked = '';
			...
			$output .= '<input type="checkbox" class="checkbox themnific-input" name="'.  esc_attr( $value['id'] ) .'" id="'. esc_attr( $value['id'] ) .'" value="true" '. $checked .' />';
		...
		case "multicheck":
			...
			$output .= '<input type="checkbox" class="checkbox themnific-input" name="'. $themnific_key .'" id="'. $themnific_key .'" value="true" '. $checked .' /><label for="'. $themnific_key .'">'. $option .'</label><br />';
				$output .= '<input type="checkbox" class="checkbox themnific-input" name="'. esc_attr( $themnific_key ) .'" id="'. esc_attr( $themnific_key ) .'" value="true" '. $checked .' /><label for="'. esc_attr( $themnific_key ) .'">'. esc_html( $option ) .'</label><br />';
		...
		case "typography":
			...
			$output .= '<select class="themnific-typography themnific-typography-style" name="'. esc_attr( $value['id'].'_style' ) . '" id="'. esc_attr( $value['id'].'_style' ) . '">';
			...
			$output .= '<input class="themnific-color themnific-typography themnific-typography-color" name="'. esc_attr( $value['id'] .'_color' ) . '" id="'. esc_attr( $value['id'] .'_color' ) . '" type="text" value="'. esc_attr( $val ) .'" />';
		...
		case "images":
			...
			foreach ($value['options'] as $key => $option) 
			 ...
			 $i++;
				...
				$output .= '<span>';
				$output .= '<input type="radio" id="themnific-radio-img-' . $value['id'] . $i . '" class="checkbox themnific-radio-img-radio" value="'. esc_attr( $key ) .'" name="'. esc_attr( $value['id'] ).'" '.$checked.' />';
				$output .= '<div class="themnific-radio-img-label">'. esc_html( $key ) .'</div>';
				$output .= '<img src="'.esc_attr( $option ).'" alt="" class="themnific-radio-img-img '. $selected .'" onClick="document.getElementById(\'themnific-radio-img-'. $value['id'] . $i.'\').checked = true;" />';
				$output .= '</span>';
